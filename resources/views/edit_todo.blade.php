                    ...
                    <form method="POST" action="{{ route('todo.update', $todo->id) }}">
                        ...
                        <div class="form-group row">
                            <label for="detail" class="col-form-label text-md-right">Detail</label>
                                ...
                                <textarea name="detail" id="detail" cols="30" rows="10" class="form-control @error('password') is-invalid @enderror" autocomplete="detail" value="{{ $todo->detail }}">{{ $todo->detail }}</textarea>
